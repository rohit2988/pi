...
<link type="text/css" rel="stylesheet" href="css/complex.css" />
...
<div class="ui-layout-west">
	...
	<div class="content">
		<span style="font-size:12px"><span><b><label >Saved Search:</label></b></span><span><select id="CboSavedSearch"><option>Please Select</option></select></span></span>
		<span style="font-size:12px"><span><b><label>Serial No:</label></b></span><span><input type="text" id="TxtSno" /></span></span>
		<span style="font-size:12px"><span><b><label>Instance:</label></b></span><span><input type="text" id="TxtInstance" /></span></span>
		<span style="font-size:12px"><span><b><label>Customer Name:</label></b></span><span><input type="text" id="TxtCName" /></span></span><br></br>
		<span><input type="button" id="BtnGo" value="Go" /><input type="button" id="BtnCancel" value="Cancel" /></span>
		<div id="accordion1" style="font-size:12; height:200">
		<a href="">My Home</a>
		<div style="font-size:12;">Feeeeeeeeel Gooooood</div>
		<a href="">Create</a>
		<div style="font-size:12;">Create</div>
		<a href="">Search</a>
		<div style="font-size:12;">Search</div>
		<a href="">Dashboard</a>
		<div style="font-size:12;">Dashboard</div>
		<a href="">Recent Request</a>
		<div style="font-size:12;">Recent Request</div>
		</div>
	</div>
